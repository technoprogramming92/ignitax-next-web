              ...
              <div className="row">
                ...
                <div className="col-xl-5 col-lg-5 col-md-5">
                  <div className="tp-blog-list-content tp-flex-column">
                    ...
                    <p><br/>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit doloremque deserunt necessitatibus provident ea pariatur possimus minima sunt dolores. Eos?</p>
                  </div>
                </div>
              </div>
            </div>
